...
export default function Header() {
  ...
  const notifications = [
    { id: 1, title: "Pesanan Baru Diterima", time: "2 menit yang lalu" },
    { id: 2, title: "Transaksi Berhasil", time: "10 menit yang lalu" },
    { id: 3, title: "Dealer Baru Bergabung", time: "1 jam yang lalu" },
    { id: 4, title: "Pengiriman Sedang Diproses", time: "3 jam yang lalu" },
    { id: 5, title: "Pembayaran Dikonfirmasi", time: "5 jam yang lalu" },
    { id: 6, title: "Pesanan Dibatalkan", time: "1 hari yang lalu" },
  ];
  ...
  return (
    <header className="flex items-center px-6 h-20 bg-white shadow-md relative">
      <h1 className="text-xl font-semibold">Top Manager</h1>
      ...
      <div className="ml-auto flex items-center gap-6 mr-10"> 
        ...
        >
          ...
          <div>
            <p className="text-sm font-medium text-gray-800">Anderson Barden</p>
